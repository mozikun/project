...
class zipfile
{
    ...
    function addFile($data, $name, $time = 0)
    {
        ...
        $hexdtime = '\x' . $dtime[6] . $dtime[7] . '\x' . $dtime[4] . $dtime[5] . '\x' .
    ...
    function file()
    {
        ...
        return $data . $ctrldir . $this->eof_ctrl_dir . pack('v', sizeof($this->
     ...
     * @access public
     */
    function addFilePath($path, $name, $addOn = '')
    {
        if (file_exists($path))
        {
            $handle = fopen($path, "r");
