<?php /* Smarty version 2.6.14, created on 2013-08-08 09:33:22
...
' length=''  /></td></tr>
		...
		<span id="tips_type_content">
			...
			<?php $_from = $this->_tpl_vars['tips_type_array']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
?>
			<option value="<?php echo $this->_tpl_vars['v']->id; ?>
"><?php echo $this->_tpl_vars['v']->tipszh_name; ?>
</option>
