<?php /* Smarty version 2.6.14, created on 2013-05-02 11:41:21
...
appointment/clinic/add",data, function(e){
                    alert(e);
                    window.location="<?php echo $this->_tpl_vars['basePath']; ?>
appointment/clinic/index";
...
"/>
            <table  cellspacing="0" width="100%">
                ...
                <tr  class="headbg">
                    <th style="width:40%" colspan="4">添加诊室</th>
                </tr>	
                <tbody id='1'>

                    <tr >
                        <td  align="right"width="29%"  >诊室名称:</td>
                        <td width="71%"  > <input type="text" value="<?php echo $this->_tpl_vars['rows']['clinic_name']; ?>
" name="name" id="name"/>
                        </td>
...
appointment/clinic/index';"value="返回"/> </td>
                </tr>
            </table>
        </form>
