<?php /* Smarty version 2.6.14, created on 2013-08-06 10:17:42
...
<table border="0" width="100%">
    <tr class="headbg">
      <td>
		<strong>婚前医学检查信息列表</strong>
	  </td>
	</tr>
		<form action="<?php echo $this->_tpl_vars['basePath']; ?>
premarital/premarital/list" id="search" method="post">
			<tr><td>
...
?>
	 <tr onmouseover="this.className='table_mouseover'" onmouseout="this.className='table_mouseout'">
	  <form action="<?php echo $this->_tpl_vars['basepath']; ?>
et/list/del/actionname/delall" method="post">
        <td><?php echo $this->_tpl_vars['li']['name']; ?>
</td>
		<td><?php echo $this->_tpl_vars['li']['moreinfo']->name_of_the_partner; ?>
</td>
		<td><?php echo $this->_tpl_vars['li']['indent']; ?>
</td>
		<td><?php echo $this->_tpl_vars['li']['moreinfo']->fill_time; ?>
</td>
		<td >
        	<a href="<?php echo $this->_tpl_vars['basePath']; ?>
premarital/premarital/add/aid/<?php echo $this->_tpl_vars['li']['id']; ?>
">[ 进入编辑 ]</a> 
			<a href="<?php echo $this->_tpl_vars['basePath']; ?>
premarital/premarital/del/id/<?php echo $this->_tpl_vars['li']['id']; ?>
" onClick="javascript:if(confirm('确定要删除 <?php echo $this->_tpl_vars['li']['name']; ?>
 的婚检信息吗')){return true;}else{return false;}">[ 删除记录 ]</a>
		</td>
	</tr>
	<?php endforeach; else: ?>
	<tr>
