<?php /* Smarty version 2.6.14, created on 2013-05-06 15:52:26
         compiled from iha_import_index.html */ ?>
...
iha/index/import" id="search" method="POST">
			<tr><td>
...
" />
                    &nbsp;年龄:<input type="text" name="age_start" class="line" value="<?php echo $this->_tpl_vars['age_start']; ?>
" style="width:28px" size="6" />
				~<input type="text" name="age_end" class="line" style="width:28px" value="<?php echo $this->_tpl_vars['age_end']; ?>
" size="6" />
                性别:&nbsp;<select name="sex">
...
" />
            ...
            <tr><td><span style="color: red; font-size: 14px;">1、导出的个人档案数据请谨慎使用，请遵守相关保密规范</span><br />2、导出个人档案数据将会影响服务器性能，请勿频繁使用<br />3、导出个人档案数据过多或者导出过程卡死时请联系管理员修改导出上限，当前上限为<?php echo $this->_tpl_vars['per_mount']; ?>
