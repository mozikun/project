<?php /* Smarty version 2.6.14, created on 2013-07-26 14:44:50
...
director/index/total/region/"+region_p_id+"/org_id/"+org_id+"/sid/"+Math.random())
				}
    			return false;
    		},
    		error:function(){
...
images/load.gif\" />查询中");
        $("#totaldata").load("<?php echo $this->_tpl_vars['basePath']; ?>
director/index/total/region/"+region_p_id+"/org_id/"+org_id+"/statistics_time/"+statistics_time+"/sid/"+Math.random());
...
<table border="0" width="100%">
    ...
    <tr class="headbg">
        <th colspan="6">
        	院长日报(<span id="show_time"><?php echo $this->_tpl_vars['statistics_time']; ?>
</span>)
        </th>
	</tr>
	</thead>
...
" />
        ...
        <br />
         <input type="text" class="Wdate" style="margin-top:20px; width:100px;" value="<?php echo $this->_tpl_vars['statistics_time']; ?>
" onFocus="WdatePicker({firstDayOfWeek:1})"  MINDATE="2000-1-1" MAXDATE="2099-12-31" name="statistics_time" id="statistics_time"/><br/>
