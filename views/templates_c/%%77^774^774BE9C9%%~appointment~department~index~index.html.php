<?php /* Smarty version 2.6.14, created on 2013-04-27 17:34:28
...
wsinfo/interface/load_xml/module_id/"+id+"/random/"+Math.random(), function(data){
        ...
        <form method="post">
            <table cellspacing="0" width="100%">
                ...
                <tr  class="headbg">
                    <th style="width:40%" colspan="4">科室列表</th>
                </tr>
...
appointment/department/add/uuid/<?php echo $this->_tpl_vars['v']['uuid']; ?>
...
appointment/department/add">添加科室</a>]</div><div style="float:right"><?php echo $this->_tpl_vars['page']; ?>
</div></td>
                </tr>
            </table>
    </form>
...
<script  language="javascript">
		   ...
		   {   
		      if(confirm('您确定删除吗?请谨慎操作')){
			   $.get("<?php echo $this->_tpl_vars['basePath']; ?>
appointment/department/del/uuid/"+id,function(data){
				   alert(data);

				   window.location='/appointment/department/index';
			   });
			  }
			   }
        </script>
