<?php /* Smarty version 2.6.14, created on 2013-08-14 22:51:41
...
web/register/department",function(department){
	$("#department").html('');
	for(i=0;i<department.length;i++){
		$("#department").append('<a department_id="'+department[i].uuid+'">'+department[i].department_name+'</a>');
	}
},"json");
}
</script>