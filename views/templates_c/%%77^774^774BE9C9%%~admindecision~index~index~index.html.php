<?php /* Smarty version 2.6.14, created on 2013-05-24 15:44:30
...
",$('#list_cm_hy'));
	   ...
	   <td >
		<!--高血压管理人数柱状图-->
		<span class='lazyload' w='170' h='184' basepath='<?php echo $this->_tpl_vars['basePath']; ?>
' chart_name='chart_bar' xml_source='<?php echo $this->_tpl_vars['basePath']; ?>
admindecision/cm/barhy/region_id/<?php echo $this->_tpl_vars['region_id']; ?>
/start_time/<?php echo $this->_tpl_vars['start_time']; ?>
/end_time/<?php echo $this->_tpl_vars['end_time']; ?>
/action/num","<?php echo $this->_tpl_vars['basePath']; ?>
'></span>
		<!--高血压规范管理率-->
		<span class='lazyload' w='170' h='184' basepath='<?php echo $this->_tpl_vars['basePath']; ?>
' chart_name='chart_bar' xml_source='<?php echo $this->_tpl_vars['basePath']; ?>
...
/start_time/<?php echo $this->_tpl_vars['start_time']; ?>
/end_time/<?php echo $this->_tpl_vars['end_time']; ?>
/action/rate","<?php echo $this->_tpl_vars['basePath']; ?>
'></span>
...
",$("#list_cm_di"));
		...
		<td >
		<!--糖尿病管理人数-->
		<span class='lazyload' w='165' h='212' basepath='<?php echo $this->_tpl_vars['basePath']; ?>
' chart_name='chart_bar' xml_source='<?php echo $this->_tpl_vars['basePath']; ?>
...
admindecision/berth/list/region/511028/field/edcw",$('#list_berth_archive_numberedcw'));
	...
	<td>
		<span class='lazyload' w='600' h='300' basepath='<?php echo $this->_tpl_vars['basePath']; ?>
' chart_name='chart_bar' xml_source='<?php echo $this->_tpl_vars['basePath']; ?>
