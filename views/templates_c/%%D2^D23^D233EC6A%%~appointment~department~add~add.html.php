<?php /* Smarty version 2.6.14, created on 2013-05-02 11:41:17
...
appointment/department/save",data, function(e){
                    alert(e);
                    window.location="<?php echo $this->_tpl_vars['basePath']; ?>
appointment/department/index";
...
"/>
            <table  cellspacing="0" width="100%">
                ...
                <tr  class="headbg">
                    <th style="width:40%" colspan="4">添加科室</th>
                </tr>	
                <tbody id='1'>

                    <tr >
                        <td  align="right"width="29%"  >科室名称:</td>
                        <td width="71%"  > <input type="text" value="<?php echo $this->_tpl_vars['rows']['department_name']; ?>
...
"/>注：序号越大，排序越靠后
                ...
                <tr  class="columnbg">
                    ...
                    <td  align="center"style="width:40%" colspan="4"><input type="button" onclick="savedata();" name="save"  value="保存"/><input type="button"  onclick="javascript:window.location='<?php echo $this->_tpl_vars['basePath']; ?>
appointment/department/index';"value="返回"/> </td>
                </tr>
            </table>
        </form>
