<?php /* Smarty version 2.6.14, created on 2013-08-22 08:00:41
...
<body>
        ...
        <form method="post">
            <table cellspacing="0" width="100%">
                ...
                <tr  class="headbg">
                    <th style="width:40%" colspan="4">优惠列表</th>
                </tr>
...
?>
                    <tr onmouseover="this.className='table_mouseover'" onmouseout="this.className='table_mouseout'">
                        <td  ><?php echo $this->_tpl_vars['v']['uuid']; ?>
</td>
                        <td  ><?php echo $this->_tpl_vars['v']['charge_id']; ?>
</td>
                        <td > <?php echo $this->_tpl_vars['v']['favorable_ratio']; ?>
</td>
                     
                        <td> <a name="edit" href="<?php echo $this->_tpl_vars['basePath']; ?>
appointment/preferential/add/action/edit/uuid/<?php echo $this->_tpl_vars['v']['uuid']; ?>
...
appointment/preferential/add/action/add">添加优惠项目</a>]</div><div style="float:right"><?php echo $this->_tpl_vars['page']; ?>
</div></td>
                </tr>
            </table>
    </form>
...
appointment/preferential/del/uuid/"+id,function(data){
				   alert(data);
				   
				   window.location='/appointment/preferential/index';
			   });
			  }
			   }
        </script>
