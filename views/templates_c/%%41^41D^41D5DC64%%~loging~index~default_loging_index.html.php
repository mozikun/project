<?php /* Smarty version 2.6.14, created on 2013-04-27 20:06:27
...
loging/index/decision'">
      ...
      <div class="bank_5" onclick="window.open('http://www.yawsj.gov.cn')">
     	<h2 class="bank_tit5 mar_t_12">门户网站</h2>
        <p class="bank_p5">雅安市卫生局门户网站<br />欢迎您！</p>
     </div>
...
loging/index/leadindex'">
      ...
      <div class="bank_8" onclick="window.location='<?php echo $this->_tpl_vars['basePath']; ?>
appointment/reservation/index'">
     	<h2 class="bank_tit7 mar_t_12" style="color:rgb(100,100,100);padding-left:20px;">预约挂号</h2>
        <p class="bank_p8"></p>
     </div>
</div>      
<!--　版权　开始 -->
