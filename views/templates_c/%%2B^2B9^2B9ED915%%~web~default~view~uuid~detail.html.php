<?php /* Smarty version 2.6.14, created on 2013-08-14 10:49:52
...
web/default/view/uuid/<?php echo $this->_tpl_vars['tips']['next']; ?>
...
web/default/view/uuid/<?php echo $this->_tpl_vars['tips']['before']; ?>
">《上一条</a><?php else: ?>没有了<?php endif; ?></div>
              <?php echo $this->_tpl_vars['article']->title; ?>
</h1>
            <div class="four_conts">
              <div class="fc_time"> 日期：<?php echo $this->_tpl_vars['article']->updated; ?>
 　　来源：<?php echo $this->_tpl_vars['article']->source; ?>
 </div>
              <div class="fc_text">
                <?php echo $this->_tpl_vars['article_content']->content; ?>
