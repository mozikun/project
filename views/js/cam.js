$(document).ready(function(){
	...
	webcam.set_swf_url('/views/js/webcam/webcam.swf');
	webcam.set_api_url('/iha/index/cam');	// The upload script
	webcam.set_quality(80);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, '/views/js/webcam/shutter.mp3');

	// Generating the embed code and adding it to the page:	
	screen.html(
		webcam.get_html(300, 368)
	);
