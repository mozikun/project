 ...
 *
 */
  class coding_measureController extends controller 
  {
  	...
  	public function indexAction()
  	{
		...
		//获取总的记录数
		$arrArg = array();
		$links = new SubPages(__ROWSOFPAGE,$numNumber,$realPage,__goodsListRowOfPage,__BASEPATH.'coding/measure/index/page/',3,$arrArg);
  	...
  	public function addAction()
  	{
  		...
  		if($id)
  		{
  			...
  			if($this->_request->getParam('ok'))
  			{
  				...
  				{
  					$this->redirect(__BASEPATH.'coding/measure/index/page/'.$page);
  				}
  			}
  		}
  		else 
  		{
  			...
  			if($this->_request->getParam('ok'))
  			{
	  			...
	  			if($measure->insert())
	  			{
	  				$this->redirect(__BASEPATH.'coding/measure/index');
	  			}
  			}
  		}
