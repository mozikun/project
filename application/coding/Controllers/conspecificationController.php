 ...
 *
 */
  class coding_conspecificationController extends controller 
  {
  	public function init()
  	{
  		require_once __SITEROOT.'library/privilege.php';
  		require_once __SITEROOT.'library/Models/con_specification.php'; 
  	...
  	public function indexAction()
  	{
		...
		//获取总的记录数
		$arrArg = array();
		$links = new SubPages(__ROWSOFPAGE,$numNumber,$realPage,__goodsListRowOfPage,__BASEPATH.'coding/conspecification/index/page/',3,$arrArg);
  	...
  	public function addAction()
  	{
  		...
  		if($id)
  		{
  			$add_tag = false;
  			//编辑
  			$specification_lone = new Tcon_specification();
  			...
  			{
  				$update_specification = new Tcon_specification();
  				...
  				{
  					$this->redirect(__BASEPATH.'coding/conspecification/index/page/'.$page);
  				}
  			}
  		}
  		else 
  		{
  			...
  			if($this->_request->getParam('ok'))
  			{
	  			...
	  			{
	  				$this->redirect(__BASEPATH.'coding/conspecification/index');
	  			}
  			}
  		}
