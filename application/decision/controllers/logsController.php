...
class decision_logsController extends controller {
	...
	public function indexAction()
	{
        ...
        ,16=>'检验记录',17=>'生命体征测量记录',18=>'病案首页',19=>'入院记录',20=>'病程记录',21=>'长期医嘱',22=>'临时医嘱',23=>'出院记录',24=>'转诊记录',25=>'就诊状态',26=>'医疗影像');//模块
...
//               	$logs_1->find();
    ...
    public function imageAction()
    {
    	...
    	$this->view->type=$type;
    	$model_array=array(1=>'个人档案',2=>'家庭档案',3=>'健康体检',4=>'高血压',5=>'糖尿病',6=>'重性精神分裂',7=>'孕产妇',8=>'儿童',9=>'婚前保健',10=>'预防接种',11=>'个人基本信息',12=>'门急诊病历',13=>'西医处方',14=>'中医处方',15=>'检查记录'
        ,16=>'检验记录',17=>'生命体征测量记录',18=>'病案首页',19=>'入院记录',20=>'病程记录',21=>'长期医嘱',22=>'临时医嘱',23=>'出院记录',24=>'转诊记录',99=>'全部');//模块
        $this->view->model_array=$model_array;
    	//判断有无数据传过去
